...
cap = cv2.VideoCapture("/Users/eshmurodov.m/Desktop/ZAKO/Projects/ML-OD-Project/data/videos/cars.mp4") #for video

model = YOLO("yolov8n.pt")

mask = cv2.imread("/Users/eshmurodov.m/Desktop/ZAKO/Projects/ML-OD-Project/data/image/mask.png")
...
classNames = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light',
              ...
              'bear', 'zebra', 'giraffe', 'backpack', 'umbrella', 'handbag', 'tie', 'suitcase', 'frisbee', 'skis', 'snowboard', 'sports ball', 'kite', 'baseball bat',
